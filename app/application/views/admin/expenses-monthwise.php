                ...
                <div class="mt">
                    <div class="filters">
                        <form action="" id="form_search_filter">
                            <div class="col-sm-6">
                                <div class="dataTables_length" id="table_contacts_length"><label>Show
                            ...
                            <div class="col-sm-6">
                                <div class="dataTables_filter">
                                    <label>From:</label>
                                    <select name="from_month" class="input-sm">
                                    ...
                                    <select name="from_year" class="input-sm">
                                    ...
                                    <label>To:</label>
                                    <select name="to_month" class="input-sm">
                                        <option value=''>Month</option>
                                        <?php
                                        for ($month = 1; $month <= 12; $month++) {
                                    ...
                                    <select name="to_year" class="input-sm">
                                        <option value=''>Year</option>
                                        <?php
                                        for ($year = date('Y'); $year >= date('Y') - 30; $year--) {
                                    ...
                                    <button type="button" class="btn btn-warning"
                                            onclick="clear_search('admin/monthwise-expense')"
                                            style="float:right"><i class="glyphicon glyphicon-remove"></i> Clear Filter
                                    </button>
                                </div>
                            </div>
                        </form>
                            ...
                            <div class="modal-body form">
                                ...
                                <div class="form-body">
                                    <div class="form-group">
                                        ...
                                        <div class="col-md-9">
                                            <input name="expense_file" data-validation="required" class="form-control"
                                                   type="file"
                                                   required>
                                        </div>
                                    </div>
