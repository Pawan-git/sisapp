    ...
    <div class="col-lg-12">
        ...
        <div class="content-panel">
            <section id="unseen">
                <div class="mt">
                    <div class="col-lg-12">
                        <button class="btn btn-warning pull-right" onclick="clear_search('admin')" style="margin-right: 10px;"><i
                                class="glyphicon glyphicon-remove"></i> Clear Search
                        </button>

                        <button class="btn btn-success pull-right" onclick="addExpenseFile()" style="margin-right: 10px;"><i
