<div class="row mb">
    <div class="col-lg-12">
        ...
        <div class="content-panel">
            <section id="unseen">
                <button class="btn btn-warning" onclick="clear_search('admin/user-list')" style="float:right"><i
                        ...
                        <div class="dataTables_length" id="table_contacts_length">
                            <label>Show
                                <select name="show"  class="form-control input-sm">
                                    ...
                                    <option
                                        value="25" <?php echo((isset($limit) && $limit == 25) ? 'selected' : ''); ?>>25
                                    </option>
                                    <option
                                        value="50" <?php echo((isset($limit) && $limit == 50) ? 'selected' : ''); ?>>50
                                    </option>
                                    <option
